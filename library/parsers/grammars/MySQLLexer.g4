...
COLUMN_FORMAT_SYMBOL:                   C O L U M N '_' F O R M A T                                 {serverVersion >= 50600}?; // Said to be available only in MySQL cluster, but nonetheless handled in the standard server parserserver well.
...
CURRENT_DATE_SYMBOL:                    C U R R E N T '_' D A T E                                   { setType(determineFunction(CURDATE_SYMBOL)); }; // Synonym, MYSQL-FUNC
CURRENT_TIME_SYMBOL:                    C U R R E N T '_' T I M E                                   { setType(determineFunction(CURTIME_SYMBOL)); }; // Synonym, MYSQL-FUNC
...
GROUP_CONCAT_SYMBOL:                    G R O U P '_' C O N C A T                                   { setType(determineFunction(GROUP_CONCAT_SYMBOL)); };
...
IO_AFTER_GTIDS_SYMBOL:                  I O '_' A F T E R '_' G T I D S                             {serverVersion >= 50600}?; // MYSQL, FUTURE-USE
IO_BEFORE_GTIDS_SYMBOL:                 I O '_' B E F O R E '_' G T I D S                           {serverVersion >= 50600}?; // MYSQL, FUTURE-USE
...
LOCALTIMESTAMP_SYMBOL:                  L O C A L T I M E S T A M P                                 {serverVersion >= 40000}? -> type(NOW_SYMBOL); // Synonym
...
MASTER_SSL_VERIFY_SERVER_CERT_SYMBOL:   M A S T E R '_' S S L '_' V E R I F Y '_' S E R V E R '_' C E R T {serverVersion >= 50100}?;
...
MASTER_HEARTBEAT_PERIOD_SYMBOL:         M A S T E R '_' H E A R T B E A T '_' P E R I O D           {serverVersion >= 50500}?;
...
MAX_STATEMENT_TIME_SYMBOL:              M A X '_' S T A T E M E N T '_' T I M E                     {50704 < serverVersion && serverVersion < 50708}?;
...
NOT_SYMBOL:                             N O T                                                       { setType(isSqlModeActive(HighNotPrecedence) ? NOT2_SYMBOL: NOT_SYMBOL); }; // SQL-2003-R
...
REPLICATE_IGNORE_TABLE_SYMBOL:          R E P L I C A T E '_' I G N O R E '_' T A B L E             {serverVersion >= 50700}?;
REPLICATE_WILD_DO_TABLE_SYMBOL:         R E P L I C A T E '_' W I L D '_' D O '_' T A B L E         {serverVersion >= 50700}?;
REPLICATE_WILD_IGNORE_TABLE_SYMBOL:     R E P L I C A T E '_' W I L D '_' I G N O R E '_' T A B L E {serverVersion >= 50700}?;
...
SESSION_USER_SYMBOL:                    S E S S I O N '_' U S E R                                   { setType(determineFunction(USER_SYMBOL)); }; // Synonym
...
SQL_AFTER_MTS_GAPS_SYMBOL:              S Q L '_' A F T E R '_' M T S '_' G A P S                   {serverVersion >= 50606}?; // MYSQL
...
STDDEV_SAMP_SYMBOL:                     S T D D E V '_' S A M P                                     { setType(determineFunction(STDDEV_SAMP_SYMBOL)); }; // SQL-2003-N
