 ...
 */
bool MySQLParsingBase::is_identifier(unsigned int type)
{
 ...
 */
bool MySQLParsingBase::is_keyword(unsigned int type)
{
 ...
 */
bool MySQLParsingBase::is_relation(unsigned int type)
{
  switch (type)
  {
    case EQUAL_OPERATOR:
 ...
 */
bool MySQLParsingBase::is_number(unsigned int type)
{
  switch (type)
  {
    case INTEGER:
 ...
 */
bool MySQLParsingBase::is_operator(unsigned int type)
{
  switch (type)
  {
    case EQUAL_OPERATOR:
