...
static PyObject *
list_append(PyGRTListObject *self, PyObject *v)
{
  if (!v)
  {
...
static PyObject *
list_insert(PyGRTListObject *self, PyObject *args)
{
  int i;
  PythonContext *ctx= PythonContext::get_and_check();
  if (!ctx) return NULL;
...
static PyObject *
list_remove(PyGRTListObject *self, PyObject *v)
{
  if (!v)
  {
    PyErr_SetString(PyExc_ValueError, "missing argument");
...
static PyObject *
list_remove_all(PyGRTListObject *self)
{
  PythonContext *ctx= PythonContext::get_and_check();
  if (!ctx) return NULL;
...
static PyObject *
list_reorder(PyGRTListObject *self, PyObject *args)
{
  int oldi, newi;
...
PyDoc_STRVAR(reorder_doc,
             "L.reorder(oindex, nindex) -- reorder object at index");
...
{(char*)"__contenttype__", (getter)list_get_contenttype, NULL, (char*)"(content type, content object class|None)", NULL},
