...
TEST_FUNCTION(10)
{
  ValueRef source_val(tester.grt::GRT::get().unserialize("data/diff/sync-catalogs-collations/source_catalog.xml"));
  ValueRef target_val(tester.grt::GRT::get().unserialize("data/diff/sync-catalogs-collations/target_catalog.xml"));
  ...
  DbMySQLImpl *diffsql_module= tester.grt::GRT::get().get_native_module<DbMySQLImpl>();
...
TEST_FUNCTION(20)
{
  ValueRef source_val(tester.grt::GRT::get().unserialize("data/diff/sync-catalogs-rowformat/source_catalog.xml"));
  ValueRef target_val(tester.grt::GRT::get().unserialize("data/diff/sync-catalogs-rowformat/target_catalog.xml"));
...
TEST_FUNCTION(21)
{
  ValueRef source_val(tester.grt::GRT::get().unserialize("data/diff/column_rename/1_src.xml"));
  ValueRef target_val(tester.grt::GRT::get().unserialize("data/diff/column_rename/1_dst.xml"));
...
TEST_FUNCTION(22)
{
  ValueRef source_val(tester.grt::GRT::get().unserialize("data/diff/column_rename/2_src.xml"));
  ValueRef target_val(tester.grt::GRT::get().unserialize("data/diff/column_rename/2_dst.xml"));
