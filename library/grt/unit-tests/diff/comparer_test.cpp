...
TEST_FUNCTION(1)
{
    ...
    table2->name("TABLE");
    grt::NormalizedComparer caseless_normalizerget_traits(false);
...
TEST_FUNCTION(2)
{
    ...
    db_TableRef table2 = db_mysql_TableRef();
    table2->name("TABLE");
    grt::NormalizedComparer normalizerget_traits(tester.grt,true));
...
TEST_FUNCTION(3)
{
    ...
    grt::DbObjectMatchAlterOmf omf;
    grt::NormalizedComparer case_normalizerget_traits(tester.grt,true));
    ...
    grt::NormalizedComparer caseless_normalizerget_traits(tester.grt,false));
...
TEST_FUNCTION(5)
{
    ...
    grt::DbObjectMatchAlterOmf omf;
    grt::NormalizedComparer normalizer5traits);
    ...
    grt::NormalizedComparer normalizer6traits);
...
TEST_FUNCTION(7)
{
    ...
    model2.indexColumn->comment("12345");
    grt::DbObjectMatchAlterOmf omf;
    grt::NormalizedComparer normalizertraits);
    normalizer.init_omf(&omf);
    boost::shared_ptr<DiffChange> change = diff_make(model1.catalog,model2.catalog,&omf);
...
TEST_FUNCTION(9)
{
  ...
  grt::NormalizedComparer normalizerget_traitstrue));
  normalizer.init_omf(&omf);
  ...
  grt::NormalizedComparer caseless_normalizer4aget_traits(tester.grt,false));
  ...
  grt::NormalizedComparer caseless_normalizer4bget_traits(tester.grt,false));
  ...
  grt::NormalizedComparer caseless_normalizer4cget_traits(tester.grt,false));
  ...
  grt::NormalizedComparer caseless_normalizer4dget_traits(tester.grt,false));
...
TEST_FUNCTION(10)
{
    ...
    grt::NormalizedComparer normalizeropts);
    normalizer.init_omf(&omf);
    ...
    grt::NormalizedComparer normalizer2opts);
