...
static
utf8string::size_type utf8_byte_offset(const char* str, utf8string::size_type offset,
...
//
inline
utf8string::size_type utf8_byte_offset(const std::string& str, utf8string::size_type offset)
{
...
inline
utf8string::size_type utf8_char_offset(const std::string& str, utf8string::size_type offset)
{
  if(offset == utf8string::npos)
    return utf8string::npos;
...
static
utf8string::size_type utf8_find_first_of(const std::string& str, utf8string::size_type offset,
...
{
  if (length() <= (max_length + 3))  // Account for current length + "..."...it's not worth to truncate if the resulting string is bigger
    return *this;
...
utf8string::iterator::iterator(char* s, char* p)
: str(s)
{
  if( nullptr == p )
    pos = s;
...
{
  return utf8_char_offset(_inner_string, _inner_string.find((const char *)ch, utf8_byte_offset(_inner_string, pos), ch.length()));
}
