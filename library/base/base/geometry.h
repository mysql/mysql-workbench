...
namespace base {
  ...
  struct BASELIBRARY_PUBLIC_FUNC Rect
  {
    ...
    inline Point top_left() const { return Point(left(), top()); }
    inline Point top_right() const { return Point(right(), top()); }
    inline Point bottom_left() const { return Point(left(), bottom()); }
    inline Point bottom_right() const { return Point(right(), bottom()); }
