...
static struct RegisterNotifDocs
{
  RegisterNotifDocs()
  {
    base::NotificationCenter::get()->register_notification(GNUIFormCreated,
                                                           "application",
    ...
    base::NotificationCenter::get()->register_notification(GNUIFormDestroyed,
                                                           "application",
                                                           "Sent when a new form object is destroyed.",
                                                           "",
                                                           "form - identifier of the form");
    
    base::NotificationCenter::get()->register_notification("GNFormTitleDidChange",
                                                           "application",
                                                           "Sent when a form's title change.",
                                                           "",
                                                           "form - identifier of the form\n"
                                                           "title - the new title of the form");
    base::NotificationCenter::get()->register_notification("GNTextSelectionChanged",
                                                           "application",
                                                           "Sent when the selection or the caret position\n"
                                                           " in an editor changed.",
                                                           "",
                                                           "");
    base::NotificationCenter::get()->register_notification("GNFocusChanged",
                                                           "application",
                                                           "Sent when a control gets the input focus.",
                                                           "",
                                                           "");
    base::NotificationCenter::get()->register_notification("GNColorsChanged",
                                                           "application",
