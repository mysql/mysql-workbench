...
namespace mforms {
  ...
  public:
    ...
    //new node location will be to @param node
    virtual void replace_node(TreeNodeRef node) = 0;

    virtual void move_node_after(TreeNodeRef node) = 0;

    virtual void move_node_before(TreeNodeRef node) = 0;
