...
WindowsGLCanvasView ^WindowsCanvasViewerPanel::CreateGLCanvas(Form ^ownerForm, bool handleInput)
{
  ...
  canvas->set_on_queue_repaint(gcnew BaseWindowsCanvasView::Void4IntDelegate(this, &WindowsCanvasViewerPanel::OnNeedsRepaint));
  canvas->set_on_viewport_changed(gcnew BaseWindowsCanvasView::VoidVoidDelegate(this, &WindowsCanvasViewerPanel::OnViewportChanged));
  OwnerForm = ownerForm;
