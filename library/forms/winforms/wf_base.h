...
namespace Forms {
  ...
  {
  private:
    gcroot<ComponentModel::Component ^> component;
  protected:
    IntPtr ^GetBackendReference();
  ...
  public:
    ...
    template<class T>
    static T^ Create(mforms::Object *backend, ObjectWrapper *wrapper)
    {
      T ^item = gcnew T();
    ...
    {
      return GetManagedObject<Windows::Forms::Control>();
    }
    ...
    static Windows::Forms::Control^ GetControl(mforms::Object *backend)
    {
      return GetManagedObject<Windows::Forms::Control>(backend);
    }

    template<class T>
    static T* GetWrapper(Object ^object)
    {
    ...
    template<class T>
    static T* GetBackend(Object ^object)
    {
  ...
  public ref class ObjectMapper
  {
  public:
    static ComponentModel::Component^ GetManagedComponent(mforms::Object *backend);
    static mforms::Object* GetUnmanagedControl(Windows::Forms::Control^ control);
    static void* ManagedToNativeDragData(Windows::Forms::IDataObject ^dataObject, String ^format);
  };
