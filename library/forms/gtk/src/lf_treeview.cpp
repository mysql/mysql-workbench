...
template <typename T>
      std::pair<Gtk::TreeViewColumn*,int> TreeViewImpl::ColumnRecord::create_column(Gtk::TreeView *tree, const std::string &title, bool editable, bool attr, bool with_icon,
                                                      bool align_right)
{
...
template std::pair<Gtk::TreeViewColumn*,int> TreeViewImpl::ColumnRecord::create_column<Glib::ustring>(Gtk::TreeView *tree, const std::string &title, bool editable, bool attr, bool with_icon,
