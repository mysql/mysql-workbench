...
public:
  static void grt_register() {
    ...
    {
      void (workbench_model_reporting_TemplateStyleInfo::*setter)(const grt::IntegerRef &) =
        &workbench_model_reporting_TemplateStyleInfo::canUseHTMLMarkup;
      grt::IntegerRef (workbench_model_reporting_TemplateStyleInfo::*getter)() const =
        &workbench_model_reporting_TemplateStyleInfo::canUseHTMLMarkup;
      meta->bind_member(
        "canUseHTMLMarkup",
        new grt::MetaClass::Property<workbench_model_reporting_TemplateStyleInfo, grt::IntegerRef>(getter, setter));
    }
    {
      void (workbench_model_reporting_TemplateStyleInfo::*setter)(const grt::StringRef &) =
        &workbench_model_reporting_TemplateStyleInfo::description;
      grt::StringRef (workbench_model_reporting_TemplateStyleInfo::*getter)() const =
        &workbench_model_reporting_TemplateStyleInfo::description;
      meta->bind_member(
        "description",
        new grt::MetaClass::Property<workbench_model_reporting_TemplateStyleInfo, grt::StringRef>(getter, setter));
    }
    {
    ...
    {
      void (workbench_model_reporting_TemplateStyleInfo::*setter)(const grt::StringRef &) =
        &workbench_model_reporting_TemplateStyleInfo::previewImageFileName;
      grt::StringRef (workbench_model_reporting_TemplateStyleInfo::*getter)() const =
        &workbench_model_reporting_TemplateStyleInfo::previewImageFileName;
      meta->bind_member(
    ...
    {
      void (workbench_model_reporting_TemplateStyleInfo::*setter)(const grt::StringRef &) =
        &workbench_model_reporting_TemplateStyleInfo::styleTagValue;
      grt::StringRef (workbench_model_reporting_TemplateStyleInfo::*getter)() const =
        &workbench_model_reporting_TemplateStyleInfo::styleTagValue;
      meta->bind_member(
        "styleTagValue",
...
public:
  static void grt_register() {
    ...
    {
      void (workbench_model_reporting_TemplateInfo::*setter)(const grt::StringRef &) =
        &workbench_model_reporting_TemplateInfo::description;
      grt::StringRef (workbench_model_reporting_TemplateInfo::*getter)() const =
        &workbench_model_reporting_TemplateInfo::description;
      meta->bind_member(
        "description",
        new grt::MetaClass::Property<workbench_model_reporting_TemplateInfo, grt::StringRef>(getter, setter));
    }
    {
      void (workbench_model_reporting_TemplateInfo::*setter)(const grt::StringRef &) =
        &workbench_model_reporting_TemplateInfo::mainFileName;
      grt::StringRef (workbench_model_reporting_TemplateInfo::*getter)() const =
        &workbench_model_reporting_TemplateInfo::mainFileName;
      meta->bind_member(
        "mainFileName",
    ...
    }
    {
      ...
      meta->bind_member(
        "name", new grt::MetaClass::Property<workbench_model_reporting_TemplateInfo, grt::StringRef>(getter, setter));
    }
    {
      void (workbench_model_reporting_TemplateInfo::*setter)(
        const grt::ListRef<workbench_model_reporting_TemplateStyleInfo> &) =
        &workbench_model_reporting_TemplateInfo::styles;
      grt::ListRef<workbench_model_reporting_TemplateStyleInfo> (workbench_model_reporting_TemplateInfo::*getter)()
        const = &workbench_model_reporting_TemplateInfo::styles;
      meta->bind_member(
        "styles",
        new grt::MetaClass::Property<workbench_model_reporting_TemplateInfo,
                                     grt::ListRef<workbench_model_reporting_TemplateStyleInfo> >(getter, setter));
    }
  }
};
