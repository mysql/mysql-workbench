...
void checkTopics(size_t start, const std::vector<HelpTestEntry> entries) {
  for (size_t i = start; i < entries.size(); i++) {
    ...
    std::string topic = help::DbSqlEditorContextHelp::get()->helpTopicFromPosition(_helpContext, statement,
      entries[i].offset);
...
static std::vector<HelpTestEntry> singleTokenTests = {
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do area(poly)", 9, "AREA", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do asbinary(g)", 8, "ASBINARY", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do AsWKB(g)", 3, "ASBINARY", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "select astext(me)", 10, "ASTEXT", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "select contains(a, b)", 8, "CONTAINS", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do @b := -1, a = crosses(b)", 26, "CROSSES", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = geomcollfromtext(b)", 8, "GEOMCOLLFROMTEXT", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = geomcollfromwkb(b)", 8, "GEOMCOLLFROMWKB", __LINE__ },
  ...
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "SELECT ST_GLength(ST_GeomFromText(@ls));", 10, "GLENGTH", __LINE__},
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = interiorringn(b)", 8, "INTERIORRINGN", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = intersects(b, c)", 8, "INTERSECTS", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = isempty(b)", 8, "ISEMPTY", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "select issimple(a)", 9, "ISSIMPLE", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = linefromtext(b)", 8, "LINEFROMTEXT", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = linefromwkb(b)", 8, "LINEFROMWKB", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = mbrequal(a, b)", 8, "MBREQUAL", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = old_password(b)", 8, "OLD_PASSWORD", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = overlaps(b, c)", 8, "OVERLAPS", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = touches(g1, g2)", 8, "TOUCHES", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do x = 1", 3, "x", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do y = 1", 3, "y", __LINE__ },
...
static std::vector<HelpTestEntry> multiTokenTests = {
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "flush no_write_to_binlog query cache", 0, "FLUSH QUERY CACHE", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "flush no_write_to_binlog query cache", 28, "FLUSH QUERY CACHE", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "flush local query cache", 0, "FLUSH QUERY CACHE", __LINE__ },
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "select 1 from dual procedure analyse()", 20, "PROCEDURE ANALYSE", __LINE__ },
