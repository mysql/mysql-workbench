...
static std::vector<HelpTestEntry> singleTokenTests = {
  ...
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "SELECT ST_AsText(ST_EndPoint(ST_GeomFromText(@ls)));", 0, 20, "ST_ENDPOINT", __LINE__},
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "SELECT ST_AsText(ST_Envelope(ST_GeomFromText('LineString(1 1,2 2)')));", 0, 20, "ST_ENVELOPE", __LINE__},
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "select ST_equals(g1, g2)", 0, 8, "ST_EQUALS", __LINE__},
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "SELECT ST_AsText(ST_ExteriorRing(ST_GeomFromText(@poly)));", 0, 17, "ST_EXTERIORRING", __LINE__},
  ...
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "SELECT ST_AsText(ST_GeometryN(ST_GeomFromText(@gc),1));", 0, 20, "ST_GEOMETRYN", __LINE__},
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "SELECT ST_GeometryType(ST_GeomFromText('POINT(1 1)'));", 0, 20, "ST_GEOMETRYTYPE", __LINE__},
  ...
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "do a = st_geomfromwkb(b, 'text')", 0, 8, "ST_GEOMFROMWKB", __LINE__},
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "do a = st_geometryfromwkb(b, 'text')", 0, 8, "ST_GEOMFROMWKB", __LINE__},
  ...
  { MYSQL_VERSION_5_7_6, MYSQL_VERSION_HIGHER, "SELECT ST_GLength(ST_GeomFromText(@ls));", 0, 10, "GLENGTH", __LINE__},
...
static std::vector<HelpTestEntry> multiTokenTests = {
  ...
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_5_7, "show contributors", 0, 0, "SHOW CONTRIBUTORS", __LINE__ },
  { MYSQL_VERSION_LOWER, MYSQL_VERSION_5_7, "show contributors", 0, 5, "SHOW CONTRIBUTORS", __LINE__ },
  { MYSQL_VERSION_5_7, MYSQL_VERSION_HIGHER, "show contributors", 0, 0, "SHOW", __LINE__ },
  { MYSQL_VERSION_5_7, MYSQL_VERSION_HIGHER, "show contributors", 0, 5, "SHOW", __LINE__ },
