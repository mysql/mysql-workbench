...
static std::vector<HelpTestEntry> singleTokenTests = {
  // Note: queries don't need to be valid, but must be in a form which allows to find a start context for the help
  // search.
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "make this a =b", 0, 12, "ASSIGN-EQUAL",
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create function a () returns int begin close  a; end", 0, 45, "CLOSE",
   __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "select @a := date_sub(a, interval b minute)", 0, 35, "DATE_SUB",
   __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin fetch it into water; end;", 0, 45, "FETCH",
   __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "CREATE TABLE geom (g GEOMETRY);", 0, 25, "GEOMETRY",
   __LINE__}, // Topic "geometry" doesn't contain much. "Hierarchy" is better suited.
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = geometrycollection(b, c, d, e)", 0, 8, "GEOMETRYCOLLECTION",
   __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = geomfromwkb(b, 'text')", 0, 8, "GEOMFROMWKB", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = geometryfromwkb(b, 'text')", 0, 8, "GEOMFROMWKB", __LINE__},
  {MYSQL_VERSION_5_6, MYSQL_VERSION_HIGHER, "create procedure a() begin get current diagnostics; end", 0, 38,
   "GET DIAGNOSTICS", __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = mlinefromtext(b)", 0, 8, "MLINEFROMTEXT", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = mlinefromwkb(b)", 0, 8, "MLINEFROMWKB", __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = mpointfromtext(b)", 0, 8, "MPOINTFROMTEXT", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = mpointfromwkb(b)", 0, 8, "MPOINTFROMWKB", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = mpolyfromtext(b)", 0, 8, "MPOLYFROMTEXT", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = mpolyfromwkb(b)", 0, 8, "MPOLYFROMWKB", __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = numgeometries(b)", 0, 8, "NUMGEOMETRIES", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = numinteriorrings(b)", 0, 8, "NUMINTERIORRINGS", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = numpoints(b)", 0, 8, "NUMPOINTS", __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = pointfromtext(b)", 0, 8, "POINTFROMTEXT", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = pointfromwkb(b)", 0, 8, "POINTFROMWKB", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = pointn(b)", 0, 8, "POINTN", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = polyfromtext(b)", 0, 8, "POLYFROMTEXT", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = polyfromwkb(b)", 0, 8, "POLYFROMWKB", __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "select schema()", 0, 10, "SCHEMA",
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = srid(b)", 0, 8, "SRID", __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER,
   ...
   "  END;",
   4, 7, "WHILE", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "do a = within(b, c)", 0, 8, "WITHIN", __LINE__},
...
static std::vector<HelpTestEntry> multiTokenTests = {
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER,
   ...
   __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "SELECT CASE WHEN 1 > 0 THEN 'true' ELSE 'false' END;", 0, 15,
   "CASE OPERATOR", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER,
   "create procedure a() CASE 1 WHEN 1 THEN 'one'\n"
   "   WHEN 2 THEN 'two' ELSE 'more' END CASE;",
   1, 27, "CASE STATEMENT", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER,
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare b condition for 1;", 0, 27,
   "DECLARE CONDITION", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare b condition for 1;", 0, 37,
   "DECLARE CONDITION", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare b cursor;", 0, 27, "DECLARE CURSOR",
   __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare b cursor;", 0, 39, "DECLARE CURSOR",
   __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare exit handler;", 0, 27,
   "DECLARE HANDLER", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare exit handler;", 0, 44,
   "DECLARE HANDLER", __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare b, c int;", 0, 27, "DECLARE VARIABLE",
   __LINE__},
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "create procedure a() begin declare b, c int;", 0, 38, "DECLARE VARIABLE",
   __LINE__},
  ...
  {MYSQL_VERSION_LOWER, MYSQL_VERSION_HIGHER, "select 1 from dual procedure analyse()", 0, 20, "PROCEDURE ANALYSE",
   __LINE__},
