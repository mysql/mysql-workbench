...
std::string test_loading_and_saving_a_model(std::string& base_path) {
  ...
  try {
    ...
    // This is so a developer can see if the copy was created.  It will be erased on subsuquent runs (via base::remove()
    // above)
...
TEST_FUNCTION(18) {
  std::string base_path =
    "data/workbench/path_with_unicode_\xC4\x85\xC4\x87\xC4\x99/file_with_unicode_\xC4\x85\xC4\x87\xC4\x99";
