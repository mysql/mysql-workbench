 ...
 */
ObjectFlags determine_qualifier(boost::shared_ptr<MySQLScanner> scanner, std::string &qualfier)
{
 ...
 */
ObjectFlags determine_schema_table_qualifier(boost::shared_ptr<MySQLScanner> scanner, std::string &schema,
