...
#ifndef _MODEL_LAYER_IMPL_H_
#define _MODEL_LAYER_IMPL_H_
...
public:  
  mdc::AreaGroup *get_area_group() const { return _area_group; }
  virtual mdc::CanvasItem *get_canvas_item() const { return _area_group; }
...
private:
  model_Layer *self() const { return (model_Layer*)_self; }
};


#endif // _MODEL_LAYER_IMPL_H_
