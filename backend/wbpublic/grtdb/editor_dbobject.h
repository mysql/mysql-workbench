...
namespace bec {
  ...
  protected:
    parsers::MySQLParserContext::Ref _parser_context;
    parsers::MySQLParserContext::Ref _autocompletion_context; // Temporary.
    parsers::MySQLParserServices::Ref _parser_services;
