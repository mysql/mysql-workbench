...
static std::map<std::string, std::string> charsetToCollation { // Same order as returned from SHOW CHARACTER SET.
...
static std::map<std::string, std::string> collationToCharset { // Same order as returned from SHOW COLLATION.
