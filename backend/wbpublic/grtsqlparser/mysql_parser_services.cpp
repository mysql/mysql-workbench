...
MySQLParserContext::MySQLParserContext(GrtCharacterSetsRef charsets, GrtVersionRef version,
  bool case_sensitive)
{
  _version = version;
...
MySQLParserContext::Ref MySQLParserServices::createParserContext(GrtCharacterSetsRef charsets,
