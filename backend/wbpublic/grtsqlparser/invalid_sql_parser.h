...
/** Defines interface to transform single DDL statement into GRT object with special processing of syntax errors in mind.
 * In case of syntax error instance of derived class creates placeholder GRT object containing provided SQL and marks it as invalid.
 * 
 * @ingroup sqlparser
 */
