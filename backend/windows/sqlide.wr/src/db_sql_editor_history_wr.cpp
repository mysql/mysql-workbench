...
DbSqlEditorHistoryWrapper::DbSqlEditorHistoryWrapper(Ref ref)
  : _ref(ref)
{
...
{
  return dynamic_cast<ContextMenuStrip ^>(ObjectMapper::GetManagedComponent(_ref->details_model()->get_context_menu()));
}
