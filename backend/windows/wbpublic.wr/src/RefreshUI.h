...
public:
  void block_auto_refresh() { _inner->block_auto_refresh(); }
  void unblock_auto_refresh() { _inner->unblock_auto_refresh(); }
...
public:
  typedef DelegateSlot1<void, void,
    int, int> PartialRefreshSlot;
