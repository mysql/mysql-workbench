system_variable_list=[ ( 'audit_log_buffer_size',
  ...
  ( 'Ndb_slave_max_replicated_epoch',
    'The most recently committed NDB epoch on this slave. When this value is greater than or equal to Ndb_slave_last_conflict_epoch, no conflicts have yet been detected.',
    False,
    []),
  ( 'rand_seed1',
  ...
  ( 'ssl-cert',
    ...
    []),
  ( 'ssl-cipher',
    'List of permitted ciphers to use for SSL encryption',
    False,
    []),
  ( 'ssl-crl',
...
status_variable_list=[ ('Audit_log_current_size', 'Audit log file current size', False, []),
  ( 'Audit_log_event_max_drop_size',
    'Size of largest dropped audited event',
    False,
    []),
  ('Audit_log_events', 'Number of handled audited events', False, []),
  ( 'Audit_log_events_filtered',
    'Number of filtered audited events',
    False,
    []),
  ('Audit_log_events_lost', 'Number of dropped audited events', False, []),
  ('Audit_log_events_written', 'Number of written audited events', False, []),
  ...
  ( 'Com_show_create_trigger',
    ...
    False,
    ['Commands/Show']),
  ('Com_show_create_user', 'Count of SHOW CREATE USER statements', False, []),
  ( 'Com_show_databases',
  ...
  ( 'Innodb_truncated_status_writes',
    ...
    False,
    ['InnoDB/Stats']),
  ('Innodb_wake_ups', 'Number of wakeups that should not occur', False, []),
  ( 'Ndb_cluster_node_id',
