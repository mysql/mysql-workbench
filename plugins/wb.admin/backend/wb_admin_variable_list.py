system_variable_list = [ ( 'group_replication_group_name',
  ...
  ( 'binlog_expire_logs_seconds',
    'Purge binary logs after this many seconds; effects are additive with expire_logs_days',
    True,
    ['Logging/Binlog Options']),
  ...
  ( 'max_write_lock_count',
    ...
    ['Advanced/Various']),
  ( 'mecab_rc_file',
    'Path to the mecabrc configuration file for the MeCab parser for InnoDB Full-Text Search',
    False,
    ['InnoDB/Fulltext search']),
...
status_variable_list = [ ('Mysqlx_address', 'The network address X Plugin is bound to', False, ['X']),
  ( 'Mysqlx_bytes_sent',
