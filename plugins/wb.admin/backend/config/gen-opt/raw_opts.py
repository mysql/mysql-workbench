ropts = [ { 'caption': 'abort-slave-event-count',
  ...
  { 'caption': 'audit-log',
    ...
    'values': [ { 'choice': ['ON', 'OFF', 'FORCE', 'FORCE_PLUS_PERMANENT'],
                  'default': 'ON',
                  'type': 'enum'}],
    'versions': [((5, 5, 28), (5, 6, 10)), ((5, 5), (5, 6)), ()]},
  ...
  { 'caption': 'audit_log_format',
    ...
    'values': [ { 'choice': ['OLD', 'NEW'],
                ...
                { 'choice': ['OLD', 'NEW'],
                  ...
                  'inversion': (5, 7, 3),
                  'type': 'enum'}],
    'versions': [((5, 5, 34), (5, 6, 14)), ((5, 5), (5, 6)), ()]},
  ...
  { 'caption': 'authentication_windows_log_level',
    ...
    'values': [ { 'default': '0',
                  ...
                  'minimum': '0',
                  'type': 'integer'}],
    'versions': [((5, 5, 16), (5, 6, 10)), ((5, 5), (5, 6)), ()]},
  ...
  { 'caption': 'binlog_stmt_cache_size',
    ...
    'values': [ { 'bitsize': '32',
                ...
                { 'bitsize': '64',
                  ...
                  'minimum': '4096',
                  'type': 'integer'}],
    'versions': [((5, 5, 9), (5, 6, 1)), ((5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'ignore-builtin-innodb',
    ...
    'versions': [((5, 1, 33),), ((5, 1), (5, 4), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'innodb_buffer_pool_chunk_size',
    'description': 'Defines the chunk size that is used when resizing the buffer pool dynamically.',
  ...
  { 'caption': 'innodb_force_load_corrupted',
    ...
    'values': [ { 'default': 'off',
                  ...
                  'on': 'on',
                  'type': 'boolean'}],
    'versions': [((5, 5, 18), (5, 6, 3)), ((5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'innodb_io_capacity',
    ...
    'values': [ { 'bitsize': '32',
                ...
                { 'bitsize': '64',
                  ...
                  'minimum': '100',
                  'type': 'integer'}],
    'versions': [((5, 1, 38),), ((5, 1), (5, 4), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'innodb_large_prefix',
    ...
    'values': [ { 'default': 'off',
                ...
                { 'default': 'on',
                  ...
                  'on': 'on',
                  'type': 'boolean'}],
    'versions': [((5, 5, 14), (5, 6, 3)), ((5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'innodb_old_blocks_pct',
    ...
    'values': [ { 'default': '37',
                  ...
                  'minimum': '5',
                  'type': 'integer'}],
    'versions': [((5, 1, 41),), ((5, 1), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'innodb_print_all_deadlocks',
    ...
    'values': [ { 'default': 'off',
                  ...
                  'on': 'on',
                  'type': 'boolean'}],
    'versions': [((5, 5, 30), (5, 6, 2)), ((5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'innodb_rollback_segments',
    ...
    'values': [ { 'default': '128',
                  ...
                  'minimum': '1',
                  'type': 'integer'}],
    'versions': [((5, 5, 11), (5, 6, 2)), ((5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'innodb_undo_logs',
    'description': 'Defines how many of the rollback segments in the system tablespace that InnoDB uses within a transaction; replaces the innodb_rollback_segments setting',
  ...
  { 'caption': 'lc-messages',
    ...
    'versions': [((6, 0, 14),), ((5, 5), (5, 6), (5, 7), (6, 0)), ()]},
  ...
  { 'caption': 'max_sp_recursion_depth',
    ...
    'versions': [ ((5, 0, 17),),
                  ((5, 0), (5, 1), (5, 4), (5, 5), (5, 6), (5, 7), (6, 0)),
                  ()]},
  { 'caption': 'max_statement_time',
    'description': 'Statement timeout value',
    'name': 'max_statement_time',
    'optype': { 'format': 'max_statement_time=#'},
    'values': [{ 'default': '0', 'type': 'integer'}],
    'versions': [((5, 7, 4),), ((5, 7),), ()]},
  ...
  { 'caption': 'ndb-batch-size',
    ...
    'values': [ { 'default': '32768',
                  ...
                  'minimum': '0',
                  'type': 'integer'}],
    'versions': [((5, 1, 23),), ((5, 1), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'ndb-blob-write-batch-bytes',
    ...
    'values': [ { 'default': '65536',
                  ...
                  'minimum': '0',
                  'type': 'integer'}],
    'versions': [((5, 1, 51),), ((5, 1), (5, 5), (5, 6), (5, 7)), ()]},
  { 'caption': 'ndb-cluster-connection-pool',
    ...
    'values': [ { 'default': '1',
                  ...
                  'minimum': '1',
                  'type': 'integer'}],
    'versions': [((5, 1, 19),), ((5, 1), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'ndb-wait-setup',
    ...
    'values': [ { 'default': '15',
                ...
                { 'default': '30',
                  ...
                  'minimum': '0',
                  'type': 'integer'}],
    'versions': [((5, 1, 39),), ((5, 1), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'ndb_deferred_constraints',
    ...
    'values': [ { 'default': '0',
                  ...
                  'minimum': '0',
                  'type': 'integer'}],
    'versions': [((5, 1, 56),), ((5, 1), (5, 5), (5, 6), (5, 7)), ()]},
  { 'caption': 'ndb_distribution',
    ...
    'values': [ { 'choice': ['LINHASH', 'KEYHASH'],
                  'default': 'KEYHASH',
                  'type': 'enum'}],
    'versions': [((5, 1, 32),), ((5, 1), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'old-alter-table',
    ...
    'values': [ { 'default': 'off',
                  ...
                  'on': 'on',
                  'type': 'boolean'}],
    'versions': [(), ((5, 1), (5, 4), (5, 5), (5, 6), (5, 7), (6, 0)), ()]},
  ...
  { 'caption': 'performance_schema_setup_actors_size',
    ...
    'values': [{ 'default': '100', 'type': 'integer'}],
    'versions': [((5, 6, 1),), ((5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'relay_log_recovery',
    ...
    'values': [ { 'default': 'false',
                  ...
                  'on': 'true',
                  'type': 'boolean'}],
    'versions': [((6, 0, 11),), ((5, 5), (5, 6), (5, 7), (6, 0)), ()]},
  ...
  { 'caption': 'slow-start-timeout',
    ...
    'values': [ { 'default': '15000',
                  'platform': 'windows',
                  'type': 'integer'}],
    'versions': [((5, 5, 20), (5, 6, 5)), ((5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'sql-mode',
    ...
    'values': [ { 'choice': [ 'ALLOW_INVALID_DATES',
                ...
                { 'choice': [ 'ALLOW_INVALID_DATES',
                              ...
                              'STRICT_ALL_TABLES',
                              'STRICT_TRANS_TABLES'],
                  'default': 'ONLY_FULL_GROUP_BY,NO_ENGINE_SUBSTITUTION,STRICT_TRANS_TABLES',
                  'inversion': (5, 7, 5),
                  'outversion': (5, 7, 6),
                  'type': 'set'},
                { 'choice': [ 'ALLOW_INVALID_DATES',
                              ...
                              'STRICT_ALL_TABLES',
                              'STRICT_TRANS_TABLES'],
                  'default': 'ONLY_FULL_GROUP_BY,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION,STRICT_TRANS_TABLES',
                  'inversion': (5, 7, 7),
                  'type': 'set'}],
    'versions': [ (),
                  ( (4, 1),
  ...
  { 'caption': 'stored_program_cache',
    ...
    'values': [ { 'default': '256',
                ...
                { 'default': '256',
                  ...
                  'minimum': '16',
                  'type': 'integer'}],
    'versions': [((5, 5, 21), (5, 6, 5)), ((5, 5), (5, 6), (5, 7)), ()]},
  { 'caption': 'super-large-pages',
    ...
    'values': [ { 'default': 'false',
                  ...
                  'platform': 'solaris',
                  'type': 'boolean'}],
    'versions': [((5, 5, 3),), ((5, 4), (5, 5), (5, 6), (5, 7)), ()]},
  ...
  { 'caption': 'sync_relay_log',
    ...
    'values': [ { 'bitsize': '32',
                ...
                { 'bitsize': '64',
                  ...
                  'minimum': '0',
                  'type': 'integer'}],
    'versions': [((6, 0, 10),), ((5, 5), (5, 6), (5, 7), (6, 0)), ()]},
