ropts = [ { 'caption': 'group_replication_group_name',
  ...
  { 'caption': 'binlog_expire_logs_seconds',
    'description': 'Purge binary logs after this many seconds; effects are additive with expire_logs_days',
  ...
  { 'caption': 'mecab_rc_file',
    'description': 'Path to the mecabrc configuration file for the MeCab parser for InnoDB Full-Text Search',
    'name': 'mecab_rc_file',
    'values': [{ 'type': 'dirname'}],
    'versions': [((5, 7, 6),), ((5, 7), (8, 0)), ()]},
  { 'caption': 'memlock',
