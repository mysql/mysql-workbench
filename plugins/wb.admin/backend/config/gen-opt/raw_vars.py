system_vars_list =[ { 'description': 'The size of the audit log buffer',
    'dynamic': False,
  ...
  { 'description': 'Output debug log', 'dynamic': True, 'name': 'debug'},
  ...
  { 'description': 'Type of password encryption method',
    'dynamic': True,
    'name': 'old_passwords'},
...
status_vars_list =[ { 'description': 'Number of connections aborted because the client died without closing the connection properly',
    'dynamic': False,
  ...
  { 'description': 'Count of REVOKE statements',
    'dynamic': False,
    'name': 'Com_revoke'},
  ...
  { 'description': 'Number of statements for which timeout was set',
    'dynamic': False,
    'name': 'Max_statement_time_set'},
  { 'description': 'Number of statements for which timeout setting failed',
    'dynamic': False,
  ...
  { 'description': 'Number of streams that are open (used mainly for logging)',
    'dynamic': False,
    'name': 'Open_streams'},
  { 'description': 'Number of .frm files in the table cache',
    'dynamic': False,
  ...
  { 'description': 'How many connection attribute strings could not be created',
    'dynamic': False,
