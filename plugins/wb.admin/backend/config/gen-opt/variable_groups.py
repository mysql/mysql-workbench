variable_groups=[ ('audit-log', ['Logging/Audit']),
  ...
  ('auto_increment_increment', ['General/General', 'Replication/Master']),
  ('auto_increment_offset', ['General/General', 'Replication/Master']),
  ...
  ('character-set-client-handshake', ['General/International']),
  ...
  ('default-authentication-plugin', ['Security/Authentication']),
  ...
  ('disable-gtid-unsafe-statements', ['Replication/General']),
  ...
  ('eq_range_index_dive_limit', ['Advanced/General']),
  ...
  ('log-bin-use-v1-row-events', ['Logging/Binlog Options']),
  ...
  ('log-slave-updates', ['Logging/General']),
  ...
  ('master-info-repository', ['Replication/Master']),
  ...
  ('partition', ['General/Features']),
  ('performance_schema', ['Performance/Performance Schema']),
  ('performance_schema_consumer_xxx', ['Performance/Performance Schema']),
  ...
  ('performance_schema_instrument', ['Performance/Performance Schema']),
  ...
  ('relay-log-index', ['Replication/Relay Log']),
  ('relay-log-info-file', ['Replication/Relay Log']),
  ...
  ('relay-log-recovery', ['Replication/Relay Log']),
  ...
  ('server-id-bits', ['General/Informational']),
  ...
  ('skip-event-scheduler', ['General/Features']),
  ('skip-external-locking', ['General/System']),
  ...
  ('slave-checkpoint-group', ['Replication/Slave']),
  ('slave_checkpoint_group', ['Replication/Slave']),
  ('slave-checkpoint-period', ['Replication/Slave']),
  ...
  ('ssl-verify-server-cert', ['Networking/SSL']),
  ('stored_program_cache', ['General/General']),
  ('symbolic-links', ['General/System']),
  ('sync-bdb-logs', ['Advanced/Deprecated']),
  ...
  ('table_cache', []),
  ('table_definition_cache', ['Performance/General']),
  ('table_lock_wait_timeout', []),
  ('table_open_cache', ['Performance/General']),
  ('table_open_cache_instances', ['Performance/General']),
  ...
  ('user', ['General/System']),
  ('validate-password', ['Security/Validate password']),
  ('validate_password_dictionary_file', ['Security/Validate password']),
  ('validate_password_length', ['Security/Validate password']),
  ('validate_password_mixed_case_count', ['Security/Validate password']),
  ('validate_password_number_count', ['Security/Validate password']),
  ('validate_password_policy_number', ['Security/Validate password']),
  ('validate_password_special_char_count', ['Security/Validate password']),
  ('verbose', []),
  ('wait_timeout', ['Networking/Timeout Settings']),
  ('warnings', ['Advanced/Deprecated']),
  ('debug', ['Advanced/General']),
  ('skip-safemalloc', ['General/System']),
  ('skip-ssl', ['Networking/SSL']),
  ('standalone', ['Advanced/General']),
  ('enable-named-pipe', ['Networking/General']),
  ('ndb-deferred-constraints', ['Other/NDB']),
  ('ndb_deferred_constraints', ['Other/NDB']),
  ('ndb-distribution', ['Other/NDB']),
  ...
  ('old', ['General/General']),
  ('lower_case_file_system', ['General/System']),
  ('time_zone', ['General/International']),
  ('skip-falcon', ['Other/Storage Engines']),
  ('skip-ndbcluster', ['Other/Storage Engines']),
  ('one-thread', ['General/General']),
  ('skip-innodb', ['InnoDB/General']),

  ('super-large-pages', ['General/General']),
  ('binlog_impossible_mode', ['Logging/Binlog Options']),
  ...
  ('ndb-log-orig', ['Other/NDB']),
  ('ndb-recv-thread-activation-threshold', ['Other/NDB']),
  ('ndb-recv-thread-cpu-mask', ['Other/NDB']),
  ('ndb_index_stat_option', ['Other/NDB']),
  ('performance-schema-consumer-events-stages-current', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-stages-history', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-stages-history-long', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-statements-current', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-statements-history', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-statements-history-long', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-transactions-current', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-transactions-history', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-transactions-history-long', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-waits-current', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-waits-history', ['Performance/Performance Schema']),
  ('performance-schema-consumer-events-waits-history-long', ['Performance/Performance Schema']),
  ('performance-schema-consumer-global-instrumentation', ['Performance/Performance Schema']),
  ('performance-schema-consumer-statements-digest', ['Performance/Performance Schema']),
  ('performance-schema-consumer-thread-instrumentation', ['Performance/Performance Schema']),
  ...
  ('performance_schema_events_transactions_history_long_size', ['Performance/Performance Schema']),
  ('performance_schema_events_transactions_history_size', ['Performance/Performance Schema']),
  ('performance_schema_max_memory_classes', ['Performance/Performance Schema']),
  ('performance_schema_max_metadata_locks', ['Performance/Performance Schema']),
  ('performance_schema_max_prepared_statements_instances', ['Performance/Performance Schema']),
  ('performance_schema_max_program_instances', ['Performance/Performance Schema']),
  ('performance_schema_max_statement_stack', ['Performance/Performance Schema']),
  ('performance_schema_session_connect_attrs_size', ['Performance/Performance Schema']),
