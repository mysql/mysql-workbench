variable_groups = [ ('group_replication_group_name', ['Replication/Group']),
  ...
  ('mysqlx_ssl', ['Other/X']),
  ('mysqlx_ssl_key', ['Other/X']),
  ('mysqlx_ssl_ca', ['Other/X']),
  ('mysqlx_ssl_capath', ['Other/X']),
  ('mysqlx_ssl_cert', ['Other/X']),
  ('mysqlx_ssl_cipher', ['Other/X']),
  ('mysqlx_ssl_crl', ['Other/X']),
  ('mysqlx_ssl_crlpath', ['Other/X']),
