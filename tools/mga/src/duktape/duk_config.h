...
#define DUK_USE_DEBUGGER_DUMPHEAP 0
#define DUK_USE_DEBUGGER_FWD_LOGGING 1
#define DUK_USE_DEBUGGER_FWD_PRINTALERT 1
#define DUK_USE_DEBUGGER_INSPECT 1
#define DUK_USE_DEBUGGER_PAUSE_UNCAUGHT 1
#define DUK_USE_DEBUGGER_SUPPORT 1
#define DUK_USE_DEBUGGER_THROW_NOTIFY 0
