...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_statement(const SqlAstNode *tree)
{
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_table_statement(const SqlAstNode *tree)
{
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_view_statement(const SqlAstNode *tree)
{
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_routine_statement(const SqlAstNode *tree)
{
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_index_statement(const SqlAstNode *tree)
{
  // check if statement is relevant
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_logfile_group_statement(const SqlAstNode *tree)
{
  // check if statement is relevant
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_tablespace_statement(const SqlAstNode *tree)
{
  // check if statement is relevant
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_server_link_statement(const SqlAstNode *tree)
{
  // check if statement is relevant
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_trigger_statement(const SqlAstNode *tree)
{
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_create_schema_statement(const SqlAstNode *tree)
{
  // check if statement is relevant
...
Mysql_sql_normalizer::Parse_result
Mysql_sql_normalizer::process_insert_statement(const SqlAstNode *tree)
{
  _norm_stmt.clear();
  ...
  if (insert_field_spec)
  {
    ...
    if ((insert_field_spec->subitem(sql::_fields)))
    {
      ...
      if (fields_clause.empty())
        _common_sql+= insert_field_spec->restore_sql_text(_sql_statement, insert_field_spec->subitem(sql::_40), insert_field_spec->subitem(sql::_41)); // 40 == ascii('('), 41 == ascii(')')
      else
