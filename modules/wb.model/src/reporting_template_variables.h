...
// Constants used to access template parameters in reports.
//
//  Created by Mike Lischke on 2009-Aug-19.
...
const char * const REPORT_TRIGGER_CONDITION = "TRIGGER_CONDITION";
...
const char * const REPORT_TRIGGER_ORIENTATION = "TRIGGER_ORIENTATION";
const char * const REPORT_TRIGGER_REFERENCE_NEW_ROW = "TRIGGER_REFERENCE_NEW_ROW";
const char * const REPORT_TRIGGER_REFERENCE_NEW_TABLE = "TRIGGER_REFERENCE_NEW_TABLE";
const char * const REPORT_TRIGGER_REFERENCE_OLD_ROW = "TRIGGER_REFERENCE_NEW_ROW";
const char * const REPORT_TRIGGER_REFERENCE_OLD_TABLE = "TRIGGER_REFERENCE_NEW_TABLE";
