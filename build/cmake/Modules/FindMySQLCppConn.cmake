...
IF(MYSQLCPPCONN_FOUND)
  ...
  TRY_COMPILE(MYSQLCPPCONN_VERSION_1_1_5
        ${CMAKE_BINARY_DIR}/try_compile ${CMAKE_CURRENT_LIST_DIR}/check_cppconn_1_1_5.cpp
        COMPILE_DEFINITIONS "-I${MYSQLCPPCONN_INCLUDE_DIRS}")
  MESSAGE(STATUS "C++ Connector version 1.1.5 or higher: ${MYSQLCPPCONN_VERSION_1_1_5}")
  
  TRY_COMPILE(MYSQLCPPCONN_VERSION_1_1_6
        ${CMAKE_BINARY_DIR}/try_compile ${CMAKE_CURRENT_LIST_DIR}/check_cppconn_1_1_6.cpp
        COMPILE_DEFINITIONS "-I${MYSQLCPPCONN_INCLUDE_DIRS}")
  MESSAGE(STATUS "C++ Connector version 1.1.6 or higher: ${MYSQLCPPCONN_VERSION_1_1_6}")
